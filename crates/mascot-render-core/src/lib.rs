...
pub use mouth_flap::{
    ...
    MouthFlapDisplayDiffs, MouthFlapRows, MouthFlapTarget, MOUTH_CLOSED_LAYER,
    MOUTH_CLOSED_LAYER_ALT_1, MOUTH_CLOSED_LAYER_ALT_2, MOUTH_GROUP_LAYER, MOUTH_OPEN_LAYER,
};
pub use variation::{
