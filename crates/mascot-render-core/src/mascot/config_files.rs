...
pub(super) struct MascotStaticConfigFile {
    ...
    pub(super) favorite_gallery_enabled: bool,
...
pub(super) struct MascotRuntimeStateFile {
    ...
    pub(super) favorite_gallery_scale: Option<f32>,
...
impl From<&MascotTarget> for MascotRuntimeStateFile {
    fn from(target: &MascotTarget) -> Self {
        Self {
            ...
            scale: target.scale,
            favorite_gallery_scale: target.favorite_gallery_scale,
...
impl MascotRuntimeStateFile {
    pub(super) fn into_target(self) -> MascotTarget {
        MascotTarget {
            ...
            scale: self.scale,
            favorite_gallery_scale: self.favorite_gallery_scale,
