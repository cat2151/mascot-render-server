...
pub(crate) fn hot_reload_context_message(
    ...
    format!(
        "trigger=hot_reload action=reload_config hot reload入力を検出しました: config_file_changed={config_file_changed} runtime_state_changed={runtime_state_changed} ensemble_file_changed={ensemble_file_changed} psd_viewer_tui_activity_changed={psd_viewer_tui_activity_changed} window_history_file_changed={window_history_file_changed} png_changed={png_changed} scale_changed={scale_changed} ensemble_changed={ensemble_changed} ensemble_mode_changed={ensemble_mode_changed} blink_source_changed={blink_source_changed} history_path_changed={history_path_changed} placement_mode={placement_mode:?} selected_anchor_kind={selected_anchor_kind:?} shared_visual_size_px={} shared_anchor_positions={} previous_png_path={} next_png_path={} previous_zip_path={} next_zip_path={} previous_psd_path_in_zip={} next_psd_path_in_zip={} previous_config_scale={} next_config_scale={} restored_window_position={}",
