...
fn favorites_round_trip_as_toml() {
    ...
    let favorites = vec![
        FavoriteEntry {
            ...
            favorite_gallery_position: Some([300.0, 90.0]),
        },
        FavoriteEntry {
            ...
            favorite_gallery_position: Some([180.0, 24.0]),
        },
    ];
...
favorite_gallery_position = [300.0, 90.0]
...
favorite_gallery_position = [180.0, 24.0]
"#,
    )
    ...
    assert_eq!(loaded[0].favorite_gallery_position, Some([180.0, 24.0]));
}
